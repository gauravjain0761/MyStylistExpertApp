...
import {PACKAGE_NOT_EDITED, SURE_CREATE_PACKAGE} from 'AppConstants';
...
interface Props {
  ...
  visibility: boolean;
  createExpertPackage: () => void;
  setVisibility: Dispatch<SetStateAction<boolean>>;
}

const SHEET_HEIGHT = h(65);
...
const styles = {
  ...
  bottomSheet: tw`w-full h-125 bg-white rounded-t-xl items-center px-4`,
